...
<div class="input-control full-size text">                    	
	<input name="<?php echo $form_box[$k][0]; ?>" type="text" placeholder="Masukkan <?php echo $form_box[$k][1]; ?>" required>
</div>              
...
<div class="input-control full-size textarea">                    	
	<textarea name="<?php echo $form_box[6][0]; ?>" placeholder="Masukkan <?php echo $form_box[6][1]; ?>" required></textarea>
</div>
...
if($_POST[nama_tim]){
	...
	if(!$sukses){
		...
		echo "<script> alert('Data ".$_POST[nama_tim]." ditambahkan. '); </script>";
